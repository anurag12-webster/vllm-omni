...
[MOSS-TTS](https://huggingface.co/OpenMOSS-Team/MOSS-TTS) is an 8B parameter text-to-speech model from OpenMOSS, built on Qwen3 with a delay-pattern multi-codebook architecture. It supports multilingual synthesis (English, Chinese, and others) with optional style/voice instructions.
